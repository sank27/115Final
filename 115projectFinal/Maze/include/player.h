...
class Player
{
    public:
        ...
        Player(int* arr, int size);        // Constructor
        ...
        void printVals();                  // print grids which can be visited by player
        bool isThere(int val);             // check if certain grid value is in the array of valid grids
    ...
    private:
        ...
        int *a;                            // Array of valid grids player can go to
        int s;                             // Size of grids
